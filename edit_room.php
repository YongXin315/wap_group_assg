  ...
  <div style="padding: 20px 160px; display: flex; justify-content: center;">
    <div style="width: 960px; display: flex; flex-direction: column;">
      ...
      <div style="padding: 16px;">
        <div style="font-size: 32px; font-weight: 700; color: #1A0F0F;">Edit Room Details</div>
      </div>
      ...
      <form action="update_room.php" method="POST">
        ...
        <div style="padding: 12px 16px; display: flex; justify-content: flex-end; gap: 12px; flex-wrap: wrap;">
          <!-- Cancel Button (go back to manage page) -->
          <a href="manage_room.php" style="min-width: 84px; height: 40px; background: #F2E8E8; border-radius: 8px; font-weight: 700; color: #1A0F0F; display: flex; align-items: center; justify-content: center; text-decoration: none;">Cancel</a>

          <!-- Submit Button -->
          <button type="submit" style="min-width: 84px; height: 40px; background: #C72426; border: none; border-radius: 8px; font-weight: 700; color: #FAF7FA;">Save Changes</button>
        </div>
